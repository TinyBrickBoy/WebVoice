...
const Dropdown: FunctionComponent<Props> = ({onUpdate, children, ...other}) => {
    return <>
        <select
            {...other}
            className={"w-full p-2 px-3 border border-neutral-600 rounded-lg bg-neutral-700 disabled:bg-neutral-800 not-disabled:cursor-pointer disabled:cursor-not-allowed"}
